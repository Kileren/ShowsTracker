...
enum Strings {
    ...
    static let additionalApplicationSettings = string(forKey: "additionalApplicationSettings")
    static let additionally = string(forKey: "additionally")
    ...
    static let episodesTracking = string(forKey: "episodesTracking")
    static let episodesTrackingDescription = string(forKey: "episodesTrackingDescription")
    ...
    static let otherSettings = string(forKey: "otherSettings")
