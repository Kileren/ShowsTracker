    ...
    var body: some View {
        VStack {
            ...
            GeometryReader { geometry in
                PagingScrollView1(activePageIndex: self.$activePageIndex, itemCount:self.numberOfTiles ,pageWidth:geometry.size.width, tileWidth:self.tileWidth, tilePadding: self.tilePadding){
